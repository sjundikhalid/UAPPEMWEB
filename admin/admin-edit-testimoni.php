...
$id = $_GET['id'];
$query = "SELECT * FROM testimoni WHERE idTestimoni='$id'";
...
if (isset($_POST['update'])) { 
    ...
    $query = "UPDATE testimoni SET pesan='$pesan', email='$email' WHERE idTestimoni='$id'";
    if (mysqli_query($conn, $query)) {
        echo "<script>
            ...
            echo "<script>
                    alert('Data Testimoni Gagal Diperbarui');
                    document.location.href = 'admin-edit-testimoni.php?id=$id'; 
                    </script>";
        }
}
?>
...
<body>
    ...
    <div class="main--content">
        ...
        <div class="tambah--container">
            <h1 class="text-center pb-3">Edit Testimoni</h1>
            <form action="" method="POST">
                <div class="form-floating mb-3">
                    <textarea class="form-control" id="floatingTextarea" name="pesan" placeholder="Pesan" required><?= $row['pesan'] ?></textarea>
                    <label for="floatingTextarea">Pesan</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="floatingInput" name="email" value="<?= $row['email'] ?>" placeholder="Email" required>
