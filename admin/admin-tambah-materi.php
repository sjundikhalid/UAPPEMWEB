...
if (isset($_POST['tambah'])) {
    $namaMaterial = htmlspecialchars($_POST['namaMateri']);
    ...
    $checkCourse = "SELECT * FROM course WHERE idCourse='$idCourse'";
    $resultCourse = mysqli_query($conn, $checkCourse);

    if (mysqli_num_rows($resultCourse) > 0) {
        // Insert material data into the material table
        $query = "INSERT INTO materi (namaMateri, linkVideo, idCourse) VALUES ('$namaMaterial', '$linkVideo', '$idCourse')";
...
<body>
    ...
    <div class="main--content">
        ...
        <div class="form--container">
            <h1 class="text-center pb-3">Form Tambah Materi</h1>
            <form action="" method="POST">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" name="namaMaterial" placeholder="Nama Materi" required>
                    <label for="floatingInput">Nama Materi</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" name="linkVideo" placeholder="Link Video" required>
                    <label for="floatingInput">Link Video</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" name="idCourse" placeholder="ID Kursus" required>
